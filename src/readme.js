      ...
      <div>
        ...
        >
          ...
          <Panel header="下载相关" key="3" className="site-collapse-custom-panel">
            ...
            <p>当下载速度长达几分钟小于200kb/s的时候, 请立即停止下载, 换成流量（忍心花点钱买买流量吧）</p>
            <p>如果下载不动请试试切换4g/5g, 因为蜂窝网它真的不限速（他们按照下载量计费，当然喜欢你下载的越多越好）</p>
          </Panel>
          <Panel header="法律与版权" key="4" className="site-collapse-custom-panel">
            ...
            <p>法律を調べて遵守する取り組みは</p>
            <p>you are still responsible to research and comply with local laws.</p>
            <p>本公告（法律）长期有效</p>
          </Panel>
